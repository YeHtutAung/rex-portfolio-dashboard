const translations = {
    ...
    ja: {
        ...
        about: {
            title: "自己紹介",
            p1: "ミャンマーのヤンゴンでキャリアをスタートし、Infosys、日立、Huaweiなどの銀行、物流、エンタープライズクライアント向けのソフトウェア開発に5年間従事しました。",
            p2: "2019年にシンガポールに移住。Micronでは半導体製造装置を接続するソフトウェアに携わりました。現在はDW Consultingで、MediacorpのSAPシステムをGoogle、Docusign、ACRA、AWSと連携するAPI開発を担当しています。",
            p3: "システム間の課題を解決することが得意です。エンタープライズプラットフォームが政府API、クラウドサービス、レガシーデータベースと連携する必要がある場合、それが私の専門分野です。"
        },
        skills: {
            title: "スキル",
            backend: "バックエンド",
